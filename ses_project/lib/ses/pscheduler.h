 ...
 */
void pscheduler_init();

/**
 * Runs scheduler in an infinite loop.
 */
void pscheduler_run(task_t taskList_arr, uint8_t numTasks_total);
 ...
 */
bool pscheduler_add(taskDescriptor * td);
 ...
 * */
void pscheduler_remove(taskDescriptor * td);
